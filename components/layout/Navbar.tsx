  ...
  return (
    <>
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 22px",background:scrolled?"rgba(0,0,5,.97)":"rgba(0,0,5,.85)",backdropFilter:"blur(24px)",borderBottom:"1px solid rgba(255,255,255,.06)",transition:"background .3s"}}>
        <a href="/" style={{textDecoration:"none",fontFamily:"'Syne',sans-serif",fontSize:"17px",fontWeight:800,letterSpacing:"-.04em",display:"flex",alignItems:"center"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:"16px"}}>
          <div className="desktop-nav" style={{display:"flex",alignItems:"center",gap:"20px"}}>
            <a href="/pricing" style={{fontFamily:"'Space Mono',monospace",fontSize:"10px",color:"rgba(255,255,255,.5)",textDecoration:"none",letterSpacing:".04em"}}>Pricing</a>
            <a href="/cases" style={{fontFamily:"'Space Mono',monospace",fontSize:"10px",color:"rgba(255,255,255,.5)",textDecoration:"none",letterSpacing:".04em"}}>Cases</a>
          </div>
      ...
      {open&&(<div style={{position:"fixed",top:"52px",left:0,right:0,zIndex:99,background:"rgba(0,0,5,.99)",backdropFilter:"blur(24px)",borderBottom:"1px solid rgba(255,255,255,.06)",padding:"2rem",display:"flex",flexDirection:"column",gap:"1.5rem"}}>
        <a href="/pricing" onClick={()=>setOpen(false)} style={{fontSize:"12px",color:"rgba(255,255,255,.7)",textDecoration:"none",fontFamily:"'Space Mono',monospace"}}>Pricing</a>
        <a href="/cases" onClick={()=>setOpen(false)} style={{fontSize:"12px",color:"rgba(255,255,255,.7)",textDecoration:"none",fontFamily:"'Space Mono',monospace"}}>Cases</a>
