    ...
    <section style={{padding:"48px 24px 64px",background:"#000005"}}>
      <div style={{maxWidth:900,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",gap:"16px",marginBottom:"28px",padding:"20px 24px",borderRadius:"14px",border:"1px solid rgba(255,255,255,.1)",background:"rgba(255,255,255,.03)"}}>
          ...
          <a href="https://padel-town.nl" target="_blank" rel="noopener noreferrer" style={{marginLeft:"auto",fontSize:"11px",fontWeight:600,padding:"6px 14px",borderRadius:"100px",border:"1px solid rgba(255,0,170,.6)",color:"#ff00aa",textDecoration:"none",flexShrink:0,display:"inline-flex",alignItems:"center",gap:"6px"}}>Check the AI chatbot →</a>
        </div>
