          ...
          <div style={{textAlign:"center",padding:"48px 24px",borderRadius:"20px",border:"1px solid rgba(255,0,170,.2)",background:"rgba(255,0,170,.04)",position:"relative",overflow:"hidden"}}>
            ...
            <div style={{position:"relative",zIndex:1}}>
              ...
              <div style={{position:"relative",display:"inline-block"}}>
                ...
                <a href="mailto:hello@conneqtai.com" style={{position:"relative",padding:"14px 32px",fontSize:"14px",fontWeight:700,borderRadius:"10px",background:"linear-gradient(135deg,#ff00aa,#7700ff)",color:"#fff",textDecoration:"none",display:"inline-block"}}>Neem contact op</a>
              </div>
            </div>
          </div>
        </div>
