    ...
    <section style={{position:"relative",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"100px 24px 60px",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,width:"100%",maxWidth:"700px",margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"10px",marginBottom:"20px",animation:"fup3 .8s ease .05s both"}}>
          ...
          <span style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",letterSpacing:".1em",textTransform:"uppercase",color:"rgba(255,0,170,.7)",fontWeight:500}}>AI-infrastructuur voor ambitieuze bedrijven</span>
        ...
        <div style={{animation:"fup3 .8s ease .1s both",marginBottom:"20px"}}>
          ...
          <h1 style={{margin:0,padding:0}}>
            ...
            <span style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(32px,7vw,58px)",fontWeight:800,display:"block",lineHeight:1.1,letterSpacing:"-.02em",background:"linear-gradient(135deg,#fff 0%,#ff00aa 30%,#7700ff 60%,#00aaff 100%)",backgroundSize:"300% auto",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",animation:"chromeShift 4s ease infinite"}}>versneld met AI.</span>
          </h1>
        </div>
        <p style={{fontSize:"clamp(14px,2vw,16px)",color:"rgba(255,255,255,.6)",maxWidth:"480px",lineHeight:1.75,margin:"0 auto 28px",fontWeight:400,animation:"fup3 .8s ease .2s both"}}>
          Wij bouwen <strong style={{color:"rgba(255,255,255,.85)",fontWeight:600}}>AI chatbots, klantenservice systemen en workflow automatiseringen</strong> die 24/7 draaien, kosten verlagen en omzet verhogen.
        </p>
        <div style={{display:"flex",gap:"12px",justifyContent:"center",flexWrap:"wrap",marginBottom:"36px",animation:"fup3 .8s ease .25s both"}}>
          <div style={{position:"relative",display:"inline-block"}}>
            ...
            <a href="mailto:hello@conneqtai.com" style={{position:"relative",padding:"14px 32px",fontSize:"15px",fontWeight:600,borderRadius:"10px",background:"linear-gradient(135deg,#ff00aa,#7700ff)",color:"#fff",textDecoration:"none",display:"inline-block"}}>Begin nu</a>
          </div>
          <a href="#oplossingen" style={{padding:"14px 28px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"inline-block"}}>Bekijk oplossingen</a>
        </div>
