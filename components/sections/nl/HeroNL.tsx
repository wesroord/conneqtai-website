...
export default function HeroNL() {
    ...
    <section style={{position:"relative",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"100px 24px 60px",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,width:"100%",maxWidth:"700px",margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"10px",marginBottom:"20px",animation:"fup3 .8s ease .05s both"}}>
          ...
          <span style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",letterSpacing:".1em",textTransform:"uppercase",color:"rgba(255,0,170,.7)",fontWeight:500}}>AI chatbots voor ambitieuze bedrijven</span>
        ...
        <div style={{animation:"fup3 .8s ease .1s both",marginBottom:"20px"}}>
          <span style={{fontFamily:"'Inter',sans-serif",fontSize:"12px",color:"rgba(255,255,255,.7)",display:"block",letterSpacing:".08em",textTransform:"uppercase",marginBottom:"14px",fontWeight:500}}>volgende generatie</span>
          <h1 style={{margin:0,padding:0}}>
            <span style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(28px,6vw,52px)",fontWeight:700,color:"#fff",display:"block",lineHeight:1.1,letterSpacing:"-.02em"}}>Jouw bedrijf,</span>
            <span style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(32px,7vw,58px)",fontWeight:800,display:"block",lineHeight:1.1,letterSpacing:"-.02em",background:"linear-gradient(135deg,#fff 0%,#ff00aa 30%,#7700ff 60%,#00aaff 100%)",backgroundSize:"300% auto",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",animation:"chromeShift 4s ease infinite"}}>versterkt met chatbot AI.</span>
          </h1>
        </div>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"12px",marginBottom:"36px",animation:"fup3 .8s ease .25s both"}}>
          ...
          <div style={{display:"flex",gap:"10px",justifyContent:"center",flexWrap:"wrap",marginTop:"10px"}}><a href="/pricing" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>Bekijk pakketten</a><a href="/projecten" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>Bekijk projecten</a><a href="/waarom" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>Waarom ConneqtAI</a></div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"1px",background:"rgba(255,255,255,.06)",borderRadius:"12px",overflow:"hidden",border:"1px solid rgba(255,255,255,.07)",animation:"fup3 .8s ease .35s both"}}>
          {[{n:"24/7",l:"Altijd actief"},{n:"80%",l:"Geautomatiseerd"},{n:"3x",l:"Sneller"},{n:"60%",l:"Besparing"}].map(s => (
