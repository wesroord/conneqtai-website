    ...
    <section style={{position:"relative",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"100px 24px 60px",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,width:"100%",maxWidth:"700px",margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"10px",marginBottom:"20px",animation:"fup3 .8s ease .05s both"}}>
          ...
          <span style={{fontFamily:"'Inter',sans-serif",fontSize:"11px",letterSpacing:".1em",textTransform:"uppercase",color:"rgba(255,0,170,.7)",fontWeight:500}}>AI chatbots for ambitious businesses</span>
        ...
        <div style={{animation:"fup3 .8s ease .1s both",marginBottom:"20px"}}>
          ...
          <h1 style={{margin:0,padding:0}}>
            ...
            <span style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(32px,7vw,58px)",fontWeight:800,display:"block",lineHeight:1.1,letterSpacing:"-.02em",background:"linear-gradient(135deg,#fff 0%,#ff00aa 30%,#7700ff 60%,#00aaff 100%)",backgroundSize:"300% auto",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",animation:"chromeShift 4s ease infinite"}}>powered by chatbot AI.</span>
          </h1>
        </div>
        <p style={{fontSize:"clamp(14px,2vw,16px)",color:"rgba(255,255,255,.6)",maxWidth:"480px",lineHeight:1.75,margin:"0 auto 28px",fontWeight:400,animation:"fup3 .8s ease .2s both"}}>
          We build <strong style={{color:"rgba(255,255,255,.85)",fontWeight:600}}>custom AI chatbots</strong> that engage visitors, capture leads and convert customers 24/7. From a simple chatbot to a fully integrated AI system.
        </p>
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"12px",marginBottom:"36px",animation:"fup3 .8s ease .25s both"}}>
          <div style={{position:"relative",display:"inline-block"}}>
            ...
            <a href="mailto:hello@conneqtai.com" style={{position:"relative",padding:"14px 32px",fontSize:"15px",fontWeight:600,borderRadius:"10px",background:"linear-gradient(135deg,#ff00aa,#7700ff)",color:"#fff",textDecoration:"none",display:"inline-block"}}>Get your chatbot</a>
          </div>
          <div style={{display:"flex",gap:"10px",justifyContent:"center",flexWrap:"wrap",marginTop:"10px"}}><a href="/pricing" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>View packages</a><a href="/cases" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>View projects</a><a href="/why" style={{padding:"11px 24px",fontSize:"13px",fontWeight:500,borderRadius:"10px",border:"1px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.05)",color:"rgba(255,255,255,.8)",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center" as const}}>Why ConneqtAI</a></div>
        </div>
