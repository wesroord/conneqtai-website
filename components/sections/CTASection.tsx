  ...
  return(
    <section style={{padding:"64px 22px",textAlign:"center",position:"relative",overflow:"hidden",background:"#000005"}}>
      ...
      <div style={{position:"relative",zIndex:2}}>
        ...
        <p style={{fontSize:"13px",color:"rgba(255,255,255,.7)",marginBottom:"26px",maxWidth:"280px",marginLeft:"auto",marginRight:"auto",lineHeight:1.75}}>Drop me a message. Clear plan within 24 hours. No fluff.</p>
