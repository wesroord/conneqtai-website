  ...
  return(
    <section style={{padding:"64px 22px",textAlign:"center",position:"relative",overflow:"hidden",background:"#000005"}}>
      ...
      <div style={{position:"relative",zIndex:2}}>
        <span style={{fontFamily:"'Inter',sans-serif",fontSize:"9px",letterSpacing:".2em",textTransform:"uppercase",color:"rgba(255,0,170,.5)",marginBottom:"14px",display:"block"}}>ready to build</span>
        <h2 style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(26px,6.5vw,42px)",fontWeight:800,letterSpacing:"-.04em",lineHeight:1.04,marginBottom:"12px",color:"#fff"}}>Your business deserves<br/><span className="chrome">AI that actually works.</span></h2>
        <p style={{fontSize:"13px",color:"rgba(255,255,255,.65)",marginBottom:"26px",maxWidth:"280px",marginLeft:"auto",marginRight:"auto",lineHeight:1.75}}>Drop us a message. Clear plan within 24 hours. No fluff.</p>
