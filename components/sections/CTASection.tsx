  ...
  return (
    <section style={{padding:"5rem 1.5rem",textAlign:"center",position:"relative",overflow:"hidden",background:"#05050c",borderTop:"1px solid rgba(255,255,255,0.07)"}}>
      ...
      <div style={{maxWidth:680,margin:"0 auto",position:"relative"}}>
        <span style={{fontSize:"0.72rem",fontWeight:600,letterSpacing:"0.12em",textTransform:"uppercase",color:"#a89cff",display:"block",marginBottom:"1rem"}}>Get Started</span>
        <h2 style={{fontFamily:"sans-serif",fontSize:"clamp(1.8rem,4vw,3rem)",fontWeight:800,letterSpacing:"-0.02em",lineHeight:1.1,marginBottom:"1.25rem",color:"#f0f0f8"}}>Ready to implement AI<br/>in your business?</h2>
        <p style={{fontSize:"1rem",color:"rgba(240,240,248,0.5)",maxWidth:480,margin:"0 auto 2.5rem",lineHeight:1.7}}>Send us a message and we'll identify your biggest automation opportunities and show you exactly what's possible.</p>
