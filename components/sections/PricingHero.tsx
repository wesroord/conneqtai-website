  ...
  return(
    <section style={{padding:"80px 24px 48px",textAlign:"center",position:"relative",overflow:"hidden",background:"#000005"}}>
      ...
      <div style={{position:"relative",zIndex:2,maxWidth:"700px",margin:"0 auto"}}>
        <h1 style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(32px,6vw,52px)",fontWeight:800,letterSpacing:"-.02em",lineHeight:1.1,color:"#fff",marginBottom:"16px"}}>One system.<br/><span className="chrome">One price. No surprises.</span></h1>
