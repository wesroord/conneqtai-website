        ...
        <div style={{maxWidth:"900px",margin:"0 auto"}}>
          <div style={{padding:"48px",borderRadius:"20px",border:"1px solid rgba(255,0,170,.2)",background:"rgba(255,0,170,.04)",position:"relative",overflow:"hidden",textAlign:"center"}}>
            ...
            <div style={{position:"relative",zIndex:1}}>
              ...
              <h2 style={{fontFamily:"'Inter',sans-serif",fontSize:"clamp(22px,4vw,32px)",fontWeight:800,color:"#fff",marginBottom:"16px",letterSpacing:"-.02em"}}>Our mission</h2>
              <p style={{fontSize:"16px",color:"rgba(255,255,255,.8)",lineHeight:1.85,maxWidth:"600px",margin:"0 auto 32px"}}>Every business deserves a chatbot that actually works. Not a generic template. Not a tool you have to figure out yourself. A real AI system, built on your data, trained in your voice, working for your customers 24 hours a day. We exist to make that accessible to every ambitious business, regardless of size.</p>
