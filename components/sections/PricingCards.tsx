...
const P=[
  {i:"🚀",n:"Starter",t:"Most popular",p:"1.750",m:"375",d:"A smart AI chatbot that works for your business 24/7. Answers questions, captures leads and never sleeps.",f:["AI chatbot on your website","Trained on your business","Lead capture","Custom tone of voice","Basic optimisation","Monthly maintenance"],h:false},
  {i:"⚡",n:"Growth",t:"Best value",p:"3.750",m:"595",d:"Advanced AI that qualifies leads smarter, handles multiple data sources and keeps improving every month.",f:["Everything in Starter","Advanced AI training on your data","Conversation flows","Smarter lead qualification","Email notifications","Multiple data sources","Monthly optimisation and maintenance"],h:true},
  {i:"🏢",n:"Pro",t:"Max ROI",p:"7.950",m:"895",d:"The complete AI system with WhatsApp, CRM, appointment scheduling and multilingual support.",f:["Everything in Growth","WhatsApp integration","CRM connections","Appointment scheduler","Multilingual AI chatbot","Conversation analytics and optimisation","Priority support","Monthly optimisation and maintenance"],h:false},
];
    ...
    <section style={{padding:"48px 24px 64px",background:"#000005"}}>
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        ...
        <div style={{textAlign:"center",marginTop:"32px",fontFamily:"'Inter',sans-serif",fontSize:"12px",color:"rgba(255,255,255,.6)"}}>
          Prices start from the amounts shown and may vary depending on project scope. A 50% deposit is required before work begins. The remaining 50% is due upon delivery. The monthly fee starts after the chatbot goes live. Excl. VAT.
        </div>
      </div>
    </section>
  );
