...
export default function HomePageNL() {
  return (<><NavbarNL /><main style={{paddingTop:"52px"}}><HeroNL /><div style={{height:"1px",background:"linear-gradient(90deg,transparent,#ff00aa,#7700ff,#00aaff,transparent)"}} /><ServicesNL /><HowItWorksNL /><WhyConneqtAINL /><DemoSectionNL /><CTASectionNL /></main><Footer /></>);
}
